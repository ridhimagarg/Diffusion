...
parser.add_argument('--dataset_dir', type=str, default="/mount/arbeitsdaten/mudcat/Resources/Multimedia-Commons/dataset")
...
#print(model)
## added on 08.01.2023 adding for transfer learning
